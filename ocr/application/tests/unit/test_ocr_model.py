...
class OCRServiceTests(TestCase):
    ...
    def test_dark_image(self, mock_brightness):
        ...
        file = SimpleUploadedFile("dark.jpg", b"fake image content", content_type="image/jpeg")
        result = handle_uploaded_file(file)
    ...
    def test_invalid_image(self, mock_brightness):
        ...
        file = SimpleUploadedFile("corrupt.jpg", b"not an image", content_type="image/jpeg")
        result = handle_uploaded_file(file)
