...
def load_craftnet_model(
    ...
    # load craft net
    from application.model.craft_text_detector.models.craftnet import CraftNet
...
def load_refinenet_model(
    ...
    # load refine net
    from application.model.craft_text_detector.models.refinenet import RefineNet
